...
class MakesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create make" do
    assert_difference('Make.count') do
      post makes_url, params: { make: { date: @make.date, name: @make.name, phone: @make.phone, price: @make.price } }
    end
  ...
  test "should update make" do
    patch make_url(@make), params: { make: { date: @make.date, name: @make.name, phone: @make.phone, price: @make.price } }
